...
Always return JSON matching `InventoryResponse`: `type` (`completion`, `question`, or `error`), `operation`, `success`, optional `data`, `missing`, `error`, and `message`. Mark a completion only when the requested operation succeeded. The orchestrator owns sequencing and coordination.
"""
