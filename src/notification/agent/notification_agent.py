"""
Notification Agent - A2A-compliant multi-channel notification dispatch agent
"""
...
AGENT_ID = "org.ecommerce.notification_agent.v1"
...
async def execute_agent(query: str, session_id: str) -> AsyncGenerator[dict, None]:
    """
    A2A-compatible async generator for notification agent execution.

    Args:
        query: Natural language query or JSON input describing the notification to send
